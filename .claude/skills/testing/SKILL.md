---
name: testing
description: Run and extend shell script tests with rendered-template checks. Use when editing chezmoi shell templates, shared shell includes, or test runner scripts.
---
