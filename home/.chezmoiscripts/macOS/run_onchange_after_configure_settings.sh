...
sudo -v
echo "Authentication successful. Configuring macOS settings (this may take a few minutes)..."
...
# defaults write com.apple.driver.AppleBluetoothMultitouch.trackpad TrackpadRightClick -bool true # Already true
...
sudo pmset -b displaysleep 5 disksleep 5 sleep 10
